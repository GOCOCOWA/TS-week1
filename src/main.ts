...
export type OnShelfPlant = BasicPlant & StockInfo/* TODO: BasicPlant, StockInfo 組合 */ ;
...
// 目標：理解介面擴充多重介面的寫法。
export interface Price { price: number; currency:"TWD"|"USD" /* TODO: price: 型別; currency:"TWD"|"USD" */ }
...
export type CalcTotalFn = (items: CartItem[], coupon?: Coupon)=>number/* TODO: (參數型別) => 型別 */ ;
...
export function updatePlant(input: Partial<PlantBase>/* TODO */ ):Required<PlantBase> /* TODO */  {
  const existing: Required<PlantBase>/* TODO */  = { id: 1, name: "虎尾蘭", price: 480, description: "耐陰、淨化空氣" };
...
export const inventory:Inventory /* TODO */ = {
  "PLANT-1001": 42,
  "PLANT-2001": 8,
};
